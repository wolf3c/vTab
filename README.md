...
因为我是一个新的 Chrome extension 开发人员，还没有被列入 **Chrome Web Store 开发人员计划政策**，我所开发的所有插件都会出现此弹窗以提醒用户谨慎使用，但这并不代表 vTab 有问题，vTab 所有代码开源，欢迎监督，并且也有很多前端开发人员在使用 vTab，**没有任何秘密代码，请放心使用**。
